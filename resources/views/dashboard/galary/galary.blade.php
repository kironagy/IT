        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Delete Blog</h6><button aria-label="Close" class="close" data-dismiss="modal"
                ...
                <div class="modal-footer">
                    <form action="{{ route('admin.galary.destroy') }}" method="post">
                        @csrf
    ...
    <div class="row">
        <div class="modal" id="addUser">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <form action="{{ route('admin.galary.store') }}" method="post" class="modal-content"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header pd-20">
                        <h6 class="modal-title">Add Img</h6><button aria-label="Close" class="close" data-dismiss="modal"
                            type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                                ...
                                @foreach ($imgs as $img)
                                    <tr>
                                        ...
                                        <td class="gap-5 d-flex">
                                            <form action="{{ route('admin.galary.destroy') }}" method="POST">
                                                @csrf
                                                <a type="button" onclick="SelectElemnt({{ $img }})"
        ...
        <div class="modal" id="EditUser">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <form action="{{ route('admin.photos.update') }}" enctype="multipart/form-data" method="post"
                    class="modal-content">
                    @csrf
                    <div class="modal-header pd-20">
                        <h6 class="modal-title">Edit Photo</h6><button aria-label="Close" class="close"
