...
@section('js')
    ...
    <script src="{{ URL::asset('assets_2/plugins/jquery-steps/jquery.steps.min.js') }}"></script>
    <script src="{{ URL::asset('assets_2/plugins/parsleyjs/parsley.min.js') }}"></script>
    <!--Internal  Form-wizard js -->
    <script src="{{ URL::asset('assets_2/js/form-wizard.js') }}"></script>
@endsection
