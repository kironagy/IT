...
@section('css')
    ...
    <link href="{{ URL::asset('assets_2/plugins/owl-carousel/owl.carousel.css') }}" rel="stylesheet">
    <!---Internal  Multislider css-->
    <link href="{{ URL::asset('assets_2/plugins/multislider/multislider.css') }}" rel="stylesheet">
@endsection
@section('page-header')
    <!-- breadcrumb -->
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/8.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/9.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/10.jpg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="carousel slide" data-ride="carousel" id="carouselExample2">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/18.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/12.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/13.jpg') }}">
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="carousel slide" data-ride="carousel" id="carouselExample3">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/14.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/15.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/16.jpg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="carousel-inner bg-dark">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100 op-3"
                                        src="{{ URL::asset('assets_2/img/photos/17.jpg') }}">
                                ...
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100 op-3"
                                        src="{{ URL::asset('assets_2/img/photos/19.jpg') }}">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5>Third Slide</h5>
                                        <p class="tx-14">Praesent commodo cursus magna, vel scelerisque nisl consectetur.
                                        </p>
                    ...
                    <div>
                        <div class="carousel slide carousel-fade" data-ride="carousel" id="carouselExample5">
                            ...
                            <div class="carousel-inner bg-dark">
                                <div class="carousel-item active">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/20.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/1.jpg') }}">
                                </div>
                                <div class="carousel-item">
                                    <img alt="img" class="d-block w-100"
                                        src="{{ URL::asset('assets_2/img/photos/2.jpg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active"><img
                                        src="{{ URL::asset('assets_2/img/photos/1.jpg') }}" alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('assets_2/img/photos/2.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('assets_2/img/photos/3.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('assets_2/img/photos/4.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('assets_2/img/photos/5.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('assets_2/img/photos/6.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('assets_2/img/photos/7.jpg') }}"
                                        alt="img"> </div>
                                <div class="carousel-item"> <img src="{{ URL::asset('assets_2/img/photos/8.jpg') }}"
                                        alt="img"> </div>
                            </div>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <div data-target="#carousel" data-slide-to="1" class="thumb"><img
                                                src="{{ URL::asset('assets_2/img/photos/2.jpg') }}" alt="img"></div>
                                        <div data-target="#carousel" data-slide-to="2" class="thumb"><img
                                                src="{{ URL::asset('assets_2/img/photos/3.jpg') }}" alt="img"></div>
                                        <div data-target="#carousel" data-slide-to="3" class="thumb"><img
                                                src="{{ URL::asset('assets_2/img/photos/4.jpg') }}" alt="img"></div>
                                    </div>
                                    <div class="carousel-item">
                                        <div data-target="#carousel" data-slide-to="4" class="thumb"><img
                                                src="{{ URL::asset('assets_2/img/photos/5.jpg') }}" alt="img"></div>
                                        <div data-target="#carousel" data-slide-to="5" class="thumb"><img
                                                src="{{ URL::asset('assets_2/img/photos/6.jpg') }}" alt="img"></div>
                                        <div data-target="#carousel" data-slide-to="6" class="thumb"><img
                                                src="{{ URL::asset('assets_2/img/photos/7.jpg') }}" alt="img"></div>
                                        <div data-target="#carousel" data-slide-to="7" class="thumb"><img
                                                src="{{ URL::asset('assets_2/img/photos/8.jpg') }}" alt="img"></div>
                                    </div>
                                </div>
                        ...
                        <div class="MS-content">
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/1.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/2.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/3.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/4.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/5.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/6.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/7.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/8.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/9.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/10.jpg') }}" alt="" /> </a>
                            </div>
                            <div class="item">
                                <a href="#" target="_blank"> <img
                                        src="{{ URL::asset('assets_2/img/photos/11.jpg') }}" alt="" /> </a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('js')
    ...
    <script src="{{ URL::asset('assets_2/plugins/owl-carousel/owl.carousel.js') }}"></script>
    <!---Internal  Multislider js-->
    <script src="{{ URL::asset('assets_2/plugins/multislider/multislider.js') }}"></script>
    <script src="{{ URL::asset('assets_2/js/carousel.js') }}"></script>
@endsection
