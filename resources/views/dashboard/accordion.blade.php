...
@section('css')
    ...
    <link href="{{ URL::asset('assets_2/plugins/accordion/accordion.css') }}" rel="stylesheet" />
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6">
                                            <img class="img-fluid rounded"
                                                src="{{ URL::asset('assets_2/img/photos/8.jpg') }}" alt="banner image">
                                        </div>
                                        <div class="col-lg-3 col-md-6">
                                            <img class="img-fluid rounded"
                                                src="{{ URL::asset('assets_2/img/photos/10.jpg') }}" alt="banner image ">
                                        </div>
                                        <div class="col-lg-3 col-md-6">
                                            <img class="img-fluid rounded"
                                                src="{{ URL::asset('assets_2/img/photos/11.jpg') }}" alt="banner image ">
                                        </div>
                                        <div class="col-lg-3 col-md-6">
                                            <img class="img-fluid rounded "
                                                src="{{ URL::asset('assets_2/img/photos/12.jpg') }}" alt="banner image ">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    ...
    <script src="{{ URL::asset('assets_2/plugins/accordion/accordion.min.js') }}"></script>
    <script src="{{ URL::asset('assets_2/js/accordion.js') }}"></script>
@endsection
