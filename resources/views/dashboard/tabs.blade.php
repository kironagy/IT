...
@section('css')
    ...
    <link href="{{ URL::asset('assets_2/plugins/inputtags/inputtags.css') }}" rel="stylesheet">
    <!--- Custom-scroll -->
...
src="{{URL::asset('assets_2/plugins/tabs/jquery.multipurpose_tabcontent.js')}}"</script></code></pre>
                                <div class="clipboard-icon" data-clipboard-target="#element5"><i
                                        class="las la-clipboard"></i></div>
                            </figure>
                        </div>
...
src="{{URL::asset('assets_2/js/tabs.js')}}"</script></code></pre>
                                <div class="clipboard-icon" data-clipboard-target="#element5"><i
                                        class="las la-clipboard"></i></div>
                            </figure>
                        </div>
...
@section('js')
    ...
    <script src="{{ URL::asset('assets_2/plugins/inputtags/inputtags.js') }}"></script>
    <!--- Tabs JS-->
    <script src="{{ URL::asset('assets_2/plugins/tabs/jquery.multipurpose_tabcontent.js') }}"></script>
    <script src="{{ URL::asset('assets_2/js/tabs.js') }}"></script>
