...
@section('css')
    ...
    <!--Internal   Notify -->
    <link href="{{ URL::asset('assets_2/plugins/notify/css/notifIt.css') }}" rel="stylesheet" />
    <!--Internal  treeview -->
    <link href="{{ URL::asset('assets_2/plugins/treeview/treeview.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-header')
    <!-- breadcrumb -->
...
@section('js')
    ...
    <script src="{{ URL::asset('assets_2/plugins/treeview/treeview.js') }}"></script>
    <!--Internal  Notify js -->
    <script src="{{ URL::asset('assets_2/plugins/notify/js/notifIt.js') }}"></script>
    <script src="{{ URL::asset('assets_2/plugins/notify/js/notifit-custom.js') }}"></script>
@endsection
