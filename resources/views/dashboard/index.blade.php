...
@section('css')
    <!--  Owl-carousel css-->
    <link href="{{ URL::asset('asset_2/plugins/owl-carousel/owl.carousel.css') }}" rel="stylesheet" />
    <!-- Maps css -->
    <link href="{{ URL::asset('asset_2/plugins/jqvmap/jqvmap.min.css') }}" rel="stylesheet">
@endsection
@section('page-header')
    <!-- breadcrumb -->
...
@section('js')
    ...
    <script src="{{ URL::asset('asset_2/plugins/chart.js/Chart.bundle.min.js') }}"></script>
    <!-- Moment js -->
    <script src="{{ URL::asset('asset_2/plugins/raphael/raphael.min.js') }}"></script>
    <!--Internal  Flot js-->
    <script src="{{ URL::asset('asset_2/plugins/jquery.flot/jquery.flot.js') }}"></script>
    <script src="{{ URL::asset('asset_2/plugins/jquery.flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ URL::asset('asset_2/plugins/jquery.flot/jquery.flot.resize.js') }}"></script>
    <script src="{{ URL::asset('asset_2/plugins/jquery.flot/jquery.flot.categories.js') }}"></script>
    <script src="{{ URL::asset('asset_2/js/dashboard.sampledata.js') }}"></script>
    <script src="{{ URL::asset('asset_2/js/chart.flot.sampledata.js') }}"></script>
    <!--Internal Apexchart js-->
    <script src="{{ URL::asset('asset_2/js/apexcharts.js') }}"></script>
    <!-- Internal Map -->
    <script src="{{ URL::asset('asset_2/plugins/jqvmap/jquery.vmap.min.js') }}"></script>
    <script src="{{ URL::asset('asset_2/plugins/jqvmap/maps/jquery.vmap.usa.js') }}"></script>
    <script src="{{ URL::asset('asset_2/js/modal-popup.js') }}"></script>
    <!--Internal  index js -->
    <script src="{{ URL::asset('asset_2/js/index.js') }}"></script>
    <script src="{{ URL::asset('asset_2/js/jquery.vmap.sampledata.js') }}"></script>
@endsection
