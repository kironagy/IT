...
@section('css')
    ...
    <link href="{{ URL::asset('assets_2/plugins/ion-rangeslider/css/ion.rangeSlider.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('assets_2/plugins/ion-rangeslider/css/ion.rangeSlider.skinFlat.css') }}" rel="stylesheet">
@endsection
@section('page-header')
    <!-- breadcrumb -->
...
@section('js')
    ...
    <script src="{{ URL::asset('assets_2/js/rangeslider.js') }}"></script>
@endsection
