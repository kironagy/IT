...
@section('css')
    ...
    <link href="{{ URL::asset('assets_2/plugins/darggable/jquery-ui-darggable.css') }}" rel="stylesheet">
@endsection
@section('page-header')
    <!-- breadcrumb -->
        ...
        <div class="row row-sm">
            <div class="col-xl-4 col-sm-12 col-md-6  col-lg-4">
                ...
                <div class="card custom-card card-draggable">
                    <img alt="Image" class="img-fluid card-img-top" src="{{ URL::asset('assets_2/img/photos/1.jpg') }}">
                    <div class="card-body">
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                            card's content.</p>
                    </div>
...
@section('js')
    ...
    <script src="{{ URL::asset('assets_2/plugins/darggable/jquery-ui-darggable.min.js') }}"></script>
    <script src="{{ URL::asset('assets_2/plugins/darggable/darggable.js') }}"></script>
@endsection
