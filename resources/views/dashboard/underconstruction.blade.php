...
@section('css')
    ...
    <link href="{{ URL::asset('assets_2/plugins/sidemenu-responsive-tabs/css/sidemenu-responsive-tabs.css') }}"
        rel="stylesheet">
@endsection
@section('content')
            ...
            <div class="col-md-5 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div class="row wd-100p mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                        <img src="{{ URL::asset('assets_2/img/media/underconstruction.png') }}"
...
@section('js')
    <!--- Jquery.Coutdown js -->
    <script src="{{ URL::asset('assets_2/plugins/jquery-countdown/jquery.lwtCountdown-1.0.js') }}"></script>
    <script src="{{ URL::asset('assets_2/plugins/jquery-countdown/count-down.js') }}"></script>
@endsection
