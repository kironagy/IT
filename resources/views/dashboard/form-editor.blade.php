        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="bg-gray-100 ql-wrapper ql-wrapper-demo">
                        <div id="quillEditor">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mg-b-20">It is Very Easy to Customize and it uses in your website apllication.</p>
                    <div class="bg-gray-100 border tx-center pd-y-20">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="wd-xl-100p ht-350">
                        <div class="bg-gray-100 ql-scrolling-demo" id="scrolling-container">
                            <div id="quillInline">
