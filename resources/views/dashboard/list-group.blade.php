...
@section('content')
                        ...
                        <div class="example">
                            <div class="list-group">
                                ...
                                <a class="list-group-item list-group-item-action flex-column align-items-start"
                                    ...
                                    <span class="d-flex">
                                        <img alt="" class="ml-3 rounded-circle avatar-md"
                                            src="{{ URL::asset('assets_2/img/faces/11.jpg') }}">
                                        <div class="">
                                            <div class="d-flex w-100 justify-content-between">
                                                <h5 class="mb-2 tx-14">List group item heading</h5><small>3 days
                                                    ago</small>
                            ...
                            <div class="list-group">
                                    ...
                                    <div class="media">
                                        <div class="d-flex mg-l-10 wd-50">
                                            <img class="ml-4 rounded-circle avatar-md"
                                                src="{{ URL::asset('assets_2/img/faces/17.jpg') }}" alt="avatar">
                                        </div>
                                ...
                                <div class="list-group-item pd-y-20">
                                    <div class="media">
                                        <div class="d-flex mg-l-10 wd-50">
                                            <img class="ml-4 rounded-circle avatar-md"
                                                src="{{ URL::asset('assets_2/img/faces/5.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <div class="media-body d-flex">
                                ...
                                <div class="list-group-item pd-y-20">
                                    <div class="media">
                                        <div class="d-flex mg-l-10 wd-50">
                                            <img class="ml-4 rounded-circle avatar-md"
                                                src="{{ URL::asset('assets_2/img/faces/12.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <div class="media-body d-flex">
	...
	<div class="list-group-item pd-y-20">
		<div class="media">
			<div class="d-flex mg-l-10 wd-50">
				<img class="ml-4 rounded-circle avatar-md" src="{{URL::asset('assets_2/img/faces/17.jpg')}}" alt="avatar">
			</div>
			<div class="media-body">
				<div class="media-body d-flex">
					<h6 class="tx-15 mb-2">Blake Vanessa</h6>
	...
	<div class="list-group-item pd-y-20">
		<div class="media">
			<div class="d-flex mg-l-10 wd-50">
				<img class="ml-4 rounded-circle avatar-md" src="{{URL::asset('assets_2/img/faces/5.jpg')}}" alt="avatar">
			</div>
			<div class="media-body">
				<div class="media-body d-flex">
					<h6 class="tx-15 mb-2">Elizabeth Parsons</h6>
	...
	<div class="list-group-item pd-y-20">
		<div class="media">
			<div class="d-flex mg-r-10 wd-50">
				<img class="ml-4 rounded-circle avatar-md" src="{{URL::asset('assets_2/img/faces/12.jpg')}}" alt="avatar">
			</div>
			<div class="media-body">
				<div class="media-body d-flex">
					<h6 class="tx-15 mb-2">Nicola Lambert</h6>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <ul class="list-group wd-md-100p users-list-group">
                                ...
                                <li class="list-group-item d-flex align-items-center">
                                    <img alt="" class="ml-3 rounded-circle avatar-md"
                                        src="{{ URL::asset('assets_2/img/faces/15.jpg') }}">
                                    <div>
                                        <h6 class="tx-15 mb-1 tx-inverse tx-semibold mg-b-0">Joel Mendez</h6><span
                                            class="d-block tx-13 text-muted">Premium Member</span>
                                    </div>
	...
	<li class="list-group-item d-flex align-items-center">
		<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('assets_2/img/faces/5.jpg')}}">
		<div>
	...
	<li class="list-group-item d-flex align-items-center">
		<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('assets_2/img/faces/6.jpg')}}">
		<div>
	...
	<li class="list-group-item d-flex align-items-center">
		<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('assets_2/img/faces/12.jpg')}}">
		<div>
