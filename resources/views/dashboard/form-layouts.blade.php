                                ...
                                <div class="form-group">
                                    ...
                                    <div class="pos-relative">
                                        ...
                                        <div class="d-flex pos-absolute t-5 r-10"><img alt=""
                                                class="wd-30 mg-r-5" src="{{ URL::asset('assets_2/img/visa.png') }}"> <img
                                                alt="" class="wd-30"
                                                src="{{ URL::asset('assets_2/img/mastercard.png') }}"></div>
                                    </div>
                                </div>
                                <div class="form-group">
...
@section('js')
    ...
    <!-- Form-layouts js -->
    <script src="{{ URL::asset('assets_2/js/form-layouts.js') }}"></script>
@endsection
